...
<?php /*%%SmartyHeaderCode:2528101235b7ae15ae15f77-19675306%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2528101235b7ae15ae15f77-19675306',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b7ae15b17dde8_12171425',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b7ae15b17dde8_12171425')) {function content_5b7ae15b17dde8_12171425($_smarty_tpl) {?>
...
<?php $_tmp9=ob_get_clean();?><?php echo smartyTranslate(array('s'=>'%refund_date% - %refund_amount%','sprintf'=>array('%refund_date%'=>$_tmp8,'%refund_amount%'=>$_tmp9),'d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
<br />
					<?php } ?>
					</span>
				</span>
...
<?php $_tmp10=ob_get_clean();?><?php echo smartyTranslate(array('s'=>'%return_date% - %return_quantity% - %return_state%','sprintf'=>array('%return_date%'=>$_tmp10,'%return_quantity%'=>$_smarty_tpl->tpl_vars['return']->value['product_quantity'],'3return_state%'=>$_smarty_tpl->tpl_vars['return']->value['state']),'d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
<br />
					<?php } ?>
					</span>
				</span>
